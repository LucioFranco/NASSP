...
public:
	...
	static BOOL CALLBACK DlgProcAutosave (HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
...
BOOL CALLBACK ProjectApolloConfigurator::DlgProcAutosave (HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	char buffer[100];
